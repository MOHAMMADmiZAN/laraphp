            ...
            <div class="row">
                <div class="col-12">
                    <div class="featured-active2 owl-carousel next-prev-style">
                        ...
                        <div class="featured-wrap">
                            <div class="featured-img">
                                <img src="{{asset("assets/frontend/assets/")}}/images/featured/7.jpg" alt="">
                                <div class="featured-content">
                        ...
                        <div class="featured-wrap">
                            <div class="featured-img">
                                <img src="{{asset("assets/frontend/assets/")}}/images/featured/8.jpg" alt="">
                                <div class="featured-content">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-title">
                        <h2>Best Seller</h2>
                        <img src="{{asset("assets/frontend/assets/")}}/images/section-title.png" alt="">
                    </div>
                </div>
            </div>
            <ul class="row">
                <li class="col-xl-3 col-lg-4 col-sm-6 col-12">
                    <div class="product-wrap">
                        <div class="product-img">
                            <img src="{{asset("assets/frontend/assets/")}}/images/product/1.jpg" alt="">
                ...
                <li class="col-xl-3 col-lg-4 col-sm-6 col-12">
                    <div class="product-wrap">
                        <div class="product-img">
                            <img src="{{asset("assets/frontend/assets/")}}/images/product/2.jpg" alt="">
                            <div class="product-icon flex-style">
                                <ul>
                                    <li><a data-toggle="modal" data-target="#exampleModalCenter"
                                           href="javascript:void(0);"><i class="fa fa-eye"></i></a></li>
                ...
                <li class="col-xl-3 col-lg-4 col-sm-6 col-12">
                    <div class="product-wrap">
                        <div class="product-img">
                            <img src="{{asset("assets/frontend/assets/")}}/images/product/3.jpg" alt="">
                            <div class="product-icon flex-style">
                                <ul>
                                    <li><a data-toggle="modal" data-target="#exampleModalCenter"
                                           href="javascript:void(0);"><i class="fa fa-eye"></i></a></li>
                ...
                <li class="col-xl-3 col-lg-4 col-sm-6 col-12">
                    <div class="product-wrap">
                        <div class="product-img">
                            <img src="{{asset("assets/frontend/assets/")}}/images/product/4.jpg" alt="">
                            <div class="product-icon flex-style">
                                <ul>
                                    <li><a data-toggle="modal" data-target="#exampleModalCenter"
                                           href="javascript:void(0);"><i class="fa fa-eye"></i></a></li>
              ...
              @foreach($products as $data)
                    <li class="col-xl-3 col-lg-4 col-sm-6 col-12">
                        <div class="product-wrap">
                            ...
                            <div class="product-content">
                                <h3><a href="single-product.html">{{$data->product_name}}</a></h3>
                ...
                <div class="col-md-10 offset-md-1 col-12">
                    <div class="testmonial-active owl-carousel">
                        <div class="test-items test-items2">
                            ...
                            <div class="test-img2">
                                <img src="{{asset("assets/frontend/assets/")}}/images/test/1.png" alt="">
                            </div>
                        </div>
                        <div class="test-items test-items2">
                            <div class="test-content">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body d-flex">
                    <div class="product-single-img w-50">
                        <img src="{{asset("assets/frontend/assets/")}}/images/product/product-details.jpg" alt="">
                    </div>
