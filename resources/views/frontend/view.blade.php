...
<!-- Mirrored from themepresss.com/tf/html/tohoney/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 02 Oct 2021 14:25:55 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <!-- jquery-ui.css -->
    <link rel="stylesheet" href="{{asset("assets/frontend/assets/")}}/css/jquery-ui.css">
    <!-- metisMenu.min.css -->
...
<body>
                        ...
                        <ul class="search-cart-wrapper d-flex">
                            ...
                            <li>
                                ...
                                <ul class="cart-wrap dropdown_style">
                                    <li class="cart-items">
                                        <div class="cart-img">
                                            <img src="{{asset("assets/frontend/assets/")}}/images/cart/1.jpg" alt="">
                                        </div>
                                    ...
                                    <li class="cart-items">
                                        <div class="cart-img">
                                            <img src="{{asset("assets/frontend/assets/")}}/images/cart/3.jpg" alt="">
                                        </div>
                                        <div class="cart-content">
                                            <a href="cart.html">Pure Nature Product</a>
                                            <span>QTY : 1</span>
                            ...
                            <li>
                                ...
                                <ul class="cart-wrap dropdown_style">
                                    ...
                                    <li class="cart-items">
                                        <div class="cart-img">
                                            <img src="{{asset("assets/frontend/assets/")}}/images/cart/2.jpg" alt="">
                                        </div>
                                        <div class="cart-content">
                                            <a href="cart.html">Pure Nature Product</a>
                                            <span>QTY : 1</span>
    ...
    <!-- scrollup.js -->
    <script src="{{asset("assets/frontend/assets/")}}/js/scrollup.js"></script>
    <!-- isotope.pkgd.min.js -->
    ...
    <!-- jquery.zoom.min.js -->
    <script src="{{asset("assets/frontend/assets/")}}/js/jquery.zoom.min.js"></script>
    <!-- countdown.js -->
    <script src="{{asset("assets/frontend/assets/")}}/js/countdown.js"></script>
    <!-- swiper.min.js -->
    <script src="{{asset("assets/frontend/assets/")}}/js/swiper.min.js"></script>
    <!-- metisMenu.min.js -->
    <script src="{{asset("assets/frontend/assets/")}}/js/metisMenu.min.js"></script>
    <!-- mailchimp.js -->
